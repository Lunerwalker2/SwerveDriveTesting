...
public class SwerveCore extends OpMode {
    ...
    protected DcMotor motorRightRear;
    protected DcMotor motorLeftRear;

    protected Servo   servoRightFront;
    protected Servo   servoLeftFront;
    protected Servo   servoRightRear;
    protected Servo   servoLeftRear;

    SwerveWheel swerveRightFront;
    SwerveWheel swerveLeftFront;
    SwerveWheel swerveRightRear;
    SwerveWheel swerveLeftRear;
    protected SwerveDrive ourSwerve;

    // servos for game elements

    protected Servo goalArm;
    protected Servo goalClaw;

    //intake mechanisms
    protected DcMotor leftIntake;
    protected DcMotor rightIntake;
    protected CRServo intServo;
...
//        servoRightRear.scaleRange(1.0/12,11.0/12);
        ...
        // Wobble Goal mover
        goalClaw = hardwareMap.servo.get("clawServo");
        swerveDebugDevice(500, "WobbleGoalClaw", goalClaw);
        goalArm = hardwareMap.servo.get("armServo");
        swerveDebugDevice(500, "Wobble Goal Arm", goalArm);
        goalArm.setDirection(Servo.Direction.REVERSE);

        //intake
        leftIntake = hardwareMap.dcMotor.get("Lintake");
        rightIntake = hardwareMap.dcMotor.get("Rintake");
        ...
        intServo = hardwareMap.crservo.get("Sintake");
...
//        parameters.accelerationIntegrationAlgorithm = new JustLoggingAccelerationIntegrator();
    ...
    public void start() {
        ...
        swerveRightFront.updateWheel(0, 0, true);
        swerveRightRear.updateWheel(0, 0, true);
        swerveLeftFront.updateWheel(0, 0, true);
        swerveLeftRear.updateWheel(0, 0, true);
    ...
    public void loopEndReporting() {
        ...
        // Swerve status
        swerveLog( "X S1", ourSwerve.getMoveLog());
        swerveLog( "X S2", ourSwerve.getMoveAdjustLog());
        swerveLog( "X S3", ourSwerve.getAngleLog());
        swerveLog( "X S4", ourSwerve.getSpeedLog());
        swerveLog( "X S5", ourSwerve.getOrientLog());
        swerveLog( "X S6", ourSwerve.getAutoDriveLog());
    }
