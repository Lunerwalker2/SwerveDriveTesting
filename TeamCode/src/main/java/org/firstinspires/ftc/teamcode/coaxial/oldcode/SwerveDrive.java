...
package org.firstinspires.ftc.teamcode.coaxial.oldcode;
...
//        curHeading = 0;
  ...
  */
    ...
    public void swankDriveWheels(double translation, double rotation){
        if (FastMath.abs(translation) > .2) {
            swerveWheels[0].updatePowersPositions(translation, .870);
            swerveWheels[1].updatePowersPositions(translation, .130);
            swerveWheels[2].updatePowersPositions(translation, .833);
            swerveWheels[3].updatePowersPositions(translation, .130);

        }
        else if (FastMath.abs(rotation) > .2) {
            swerveWheels[0].updatePowersPositions(rotation, .870 - .166);
            swerveWheels[1].updatePowersPositions(-rotation, .130 + .166);
            swerveWheels[2].updatePowersPositions(-rotation, .833 - .166);
            swerveWheels[3].updatePowersPositions(rotation, .130 + .166);
        }
        else {
            swerveWheels[0].updatePowersPositions(0, .870);
            swerveWheels[1].updatePowersPositions(0, .130);
            swerveWheels[2].updatePowersPositions(0, .833);
            swerveWheels[3].updatePowersPositions(0, .130);
        }
    }
    // ***********************************************************************
